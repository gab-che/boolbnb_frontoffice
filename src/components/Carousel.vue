<template>
  <div class="container-fluid" @mouseenter="myStopFunction()" @mouseleave="nextImg()">
    <div id="carouselExampleCaptions" class="carousel slide h-100 shadow" data-bs-ride="false">
      ...
      <div class="carousel-inner">
        <div v-for="(apartment, i) in store.sponsoredApartments" :key="i"
          ...
          <router-link :to="{ path: 'appartamenti/:id' + apartment.id }" class="text-white text-decoration-none">
            <div class="img-container shadow">
              <img :src="store.backendStorage + apartment.img_cover" class="" alt="..." />
