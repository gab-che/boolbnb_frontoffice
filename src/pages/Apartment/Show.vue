...
<template>
  ...
  <transition name="fade" appear>
    <div class="container mb-5 pb-5">
      ...
      <div class="row g-4 pb-5">
        <div class="col-12 col-md-6">
          ...
          <ul class="list-group w-100">
            ...
            <li
              v-for="service in store.singleApartment.services"
        ...
        <div class="col-12 col-md-6">
          <div class="mb-3 d-flex justify-content-center">
            <img
              v-if="store.singleApartment.imgLink"
              class="w-100"
              :src="backendURL + store.singleApartment.img_cover"
              alt="Foto del posto"
            />
            <img
              v-else
              :src="store.singleApartment.img_cover"
              alt="Foto del posto"
            />
          </div>
          <div class="d-block">
            <ul class="list-group w-75 container">
              <li
                class="list-group-item service-title d-flex align-items-center"
              >
                <h6>Messaggistica</h6>
              </li>
              <li class="list-group-item">
                ...
                <router-link
                  class="btn btn-warning m-2 message-link"
                  :to="{ name: 'message' }"
      ...
      <div class="pt-5">
        <Map
          v-if="store.singleApartment.latitude"
          :appartment="[
            this.$route.params.id,
            this.store.singleApartment.address,
            this.store.singleApartment.latitude,
            store.singleApartment.longitude,
          ]"
        >
        </Map>
      </div>
